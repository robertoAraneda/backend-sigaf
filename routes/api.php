...
Route::group([
  ...
  Route::get('course-tutors/course/{course}', 'CourseTutorController@findByCourse')->name('api.courseTutors.course');
  Route::get('course-tutors/tutor/{tutor}', 'CourseTutorController@findByTutor')->name('api.courseTutors.tutor');
